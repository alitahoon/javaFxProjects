 ...
 * @author Ali Tahoon
 */
public class doctorAddController implements Initializable {
    ...
    private void handelSaveButton() {
        String query = "INSERT INTO `doctor`(`docID`, `docName`, `docShiftStart`, `docShiftEnd`, `docSalary`,"
                + " `docBirthdate`, `docDepID`, `docCliID`, `docGender`, `docGrade`, `docAddress`) VALUES ("
                + txtID.getText() + ","
                + "'" + txtName.getText() + "'" + ","
                ...
                + Database.dbconnect.getId(String.valueOf(cmpClinics.getValue()), "clinics", "cliName", "cliID")
                + ",'" + getSelectedRadioButton(rdMale, rdFemale).getText() + "',"
                + "'" + txtGrade.getText() + "'" + ","
                + "'" + txtAddress.getText() + "'" + ")";
        Database.dbconnect.insertData("doctor", query);
        txtID.setText(Database.dbconnect.autoNumber("doctor", "docID"));
        clearText();
    }
